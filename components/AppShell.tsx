  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex flex-col pb-20 lg:pb-6 relative z-10">
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="bg-slate-950 border-t border-slate-800 rounded-t-3xl max-h-[85vh] overflow-y-auto p-5 space-y-4 animate-slide-up shadow-2xl">
              ...
              {/* Superadmin Menu Mobile */}
              {isSuperAdminOrAdmin && (
                <div className="pt-2 border-t border-slate-800">
                  <p className="text-[10px] font-bold text-amber-500 uppercase tracking-wider mb-1.5 px-2">
                    ผู้ดูแลระบบ
                  </p>
                  <div className="space-y-0.5">
                    {SUPERADMIN_NAV.map((item) => {
              ...
              <div className="pt-3 border-t border-slate-800/80 text-center">
                <span className="text-[11px] font-mono text-slate-500">
                  Created by <span className="text-indigo-400 font-semibold">MIKPURINUT</span>
                </span>
              </div>
            </div>
          </div>
        ...
        {/* Main Canvas Area */}
        <main className="flex-1 min-w-0 w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 py-6 sm:py-8 flex flex-col justify-between">
          <div>{children}</div>
          <footer className="mt-14 pt-6 border-t border-white/[0.05] text-center">
            <p className="text-xs text-slate-500 font-mono">
              Investment Pro © {new Date().getFullYear()} • Created by{' '}
              <span className="text-indigo-400 font-semibold">MIKPURINUT</span>
            </p>
          </footer>
        </main>
      </div>
