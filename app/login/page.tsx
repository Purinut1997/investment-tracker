...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  OAuthSignin: 'ไม่สามารถเริ่มต้นเชื่อมต่อกับ Google ได้ กรุณาลองใหม่อีกครั้ง',
  OAuthCallbackError: 'เกิดข้อผิดพลาดในการรับข้อมูลจาก Google กรุณาลองใหม่อีกครั้ง',
  Callback: 'เกิดข้อผิดพลาดในการเชื่อมต่อกลับจาก Google กรุณาลองใหม่อีกครั้ง',
  AccessDenied: 'การเข้าสู่ระบบถูกปฏิเสธหรือไม่ได้รับอนุญาต',
  Configuration: 'การตั้งค่าระบบยืนยันตัวตนไม่ถูกต้อง กรุณาตรวจสอบ Google Client ID',
