...
5. ตอบกลับเป็น JSON Object ที่ถูกต้องเท่านั้น (ห้ามมี markdown หรือข้อความอื่นนอก JSON) ตามโครงสร้างดังนี้:
{
  ...
  "financialPerformance": {
    "revenue": "สรุปตัวเลขรายได้และการเติบโตเป็นภาษาไทย (เช่น $94.9B เติบโตแข็งแกร่ง 15% YoY ตามคาด)",
    "eps": "สรุปตัวเลขกำไรต่อหุ้น EPS และแนวโน้มเป็นภาษาไทย",
    "growth": "อัตราการเติบโต YoY/QoQ และทิศทางเป็นภาษาไทย",
    "fcf": "สรุปกระแสเงินสดอิสระ Free Cash Flow หรือสภาพคล่องเป็นภาษาไทย"
  },
